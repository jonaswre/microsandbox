...
[WINDOWS_SUPPORT.md](WINDOWS_SUPPORT.md) and
[WINDOWS_HOST_DEEP_DIVE.md](WINDOWS_HOST_DEEP_DIVE.md).
...
- [WINDOWS_SUPPORT.md](WINDOWS_SUPPORT.md) should stop listing backend and
  artifact questions as open.
- [WINDOWS_HOST_DEEP_DIVE.md](WINDOWS_HOST_DEEP_DIVE.md) should point here as
