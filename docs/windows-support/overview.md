...
Use this document to understand scope, product boundaries, blockers, and the
phased direction for Windows support.

- For runtime decomposition and current coupling analysis, see
  [Architecture Deep Dive](./architecture-deep-dive.md).
- For the chosen Windows host architecture, see
...
For the lower-level runtime decomposition, see
[Architecture Deep Dive](./architecture-deep-dive.md).
